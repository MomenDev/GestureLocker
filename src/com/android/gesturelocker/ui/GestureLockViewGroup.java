...
import com.android.gesturelocker.ui.GestureLockView.Mode;
...
public class GestureLockViewGroup extends RelativeLayout {
	...
	public static final String TAG = "GestureLockViewGroup";
		...
		if (mGestureLockViews == null) {
			...
			for (int i = 0; i < mGestureLockViews.length; i++) {
				...
				mGestureLockViews[i] = new GestureLockView(getContext(),
						...
						mFingerOnColor, mFingerUpColor, i);
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_UP:
			...
			if (mOnGestureLockViewListener != null && mChoose.size() > 0) {
				mOnGestureLockViewListener.onGestureEnd(GesturePassword
						.passwordToString(mChoose));
				if (this.mTryTimes <= 0) {
